    ...
    <div className="mx-auto max-w-3xl px-6 pb-28 pt-40">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="mt-5 max-w-xl text-sm leading-relaxed text-muted-foreground md:text-base">
          If you have two minutes, a few honest words go further than anything I could write
          about my own work. Thank you.
        </p>
      </div>
      ...
      <form
        ...
        onSubmit={handleSubmit(async (values) => {
          const res = await submitForm(`New review from ${values.name} (${rating}/5)`, {
            name: values.name,
            email: values.email,
      ...
      >
        <div className="sm:col-span-2">
          <p className="eyebrow mb-3">Your rating</p>
